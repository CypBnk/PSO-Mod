...
namespace Microsoft.Partner.SmartOffice.Services.PartnerCenter.AuditRecords
{
    ...
    public interface IAuditRecordCollectionOperations
    {
        ...
        // hinzufügen
        Task<SeekBasedResourceCollection<AuditRecord>> QueryAsync(string id, DateTime startDate, DateTime? endDate = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Queries audit records associated to the partner.
        /// </summary>
